...
- Timestamp: `2022-05-24 17:58`
- Build ID: `c65ff869-003b-4730-a52a-a0bb3b8ff0d8`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c65ff869-003b-4730-a52a-a0bb3b8ff0d8.git
$ cd c65ff869-003b-4730-a52a-a0bb3b8ff0d8
```
